      ...
      <View style={ManagerMeetingCardStyles.card}>
        <View style={ManagerMeetingCardStyles.cardTopRow}>
          ...
          <View>
            ...
            <Text style={ManagerMeetingCardStyles.subTitle}>
              {meeting.SportType}
            </Text>
          </View>
        </View>
        ...
        <View style={ManagerMeetingCardStyles.participantContainer}>
          <Text style={ManagerMeetingCardStyles.participantText}>
            {currentParticipants}
          </Text>
          <CustomSlider
            minimumValue={0}
        ...
        <View style={ManagerMeetingCardStyles.cardBottomRow}>
          {!isUserInMeeting ? (
            <TouchableOpacity
              style={ManagerMeetingCardStyles.button}
