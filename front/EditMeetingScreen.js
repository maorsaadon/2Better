...
const EditMeetingScreen = ({ route }) => {
    ...
    const handleEditButton = async () => {
        try {
          ...
          await MeetingService.updateMeetingDetails(meeting.id, selectedDate, selectedTime, location);
        ...
        <ImageBackground source={myLogoPic} style={styles.backgroundImage}>
          <KeyboardAvoidingView style={styles.container} behavior="padding">
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity onPress={() => setDatePickerVisibility(true)} style={[styles.button, styles.buttonOutline, styles.dateButtom]}>
                <Text>{selectedDate}</Text>
              </TouchableOpacity>
    
              <TouchableOpacity onPress={() => setTimePickerVisibility(true)} style={[styles.button, styles.buttonOutline, styles.timeButtom]}>
                <Text>{selectedTime}</Text>
              </TouchableOpacity>
...
//             // Update the meeting details
//             await MeetingService.updateMeetingDetails(meeting.id, date, time, location);
    
//             // Handle other operations as needed (e.g., notification)
//             // NotificationService.handleAddNewNotification(groupName,  content, "Meeting Updated", serverTimestamp());
