...
const EditGroupScreen = ({route}) => {
  ...
  const handleSave = async () => {
    try {
      ...
      navigation.replace("MyGroups"); // Go back to the Home screen after saving
    } catch (error) {
    ...
    <ImageBackground source={myLogoPic} style={styles.backgroundImage}>
      <View style={styles.container}>
        ...
        <TextInput
          ...
          onFocus={() => setParticipants('')} // Clear text on focus
        ...
        onFocus={() => setSportType('')} // Clear text on focus
