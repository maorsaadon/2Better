...
const CostumerSupportScreen = () => {
  ...
  const handleFQAPress = () => {
    Linking.openURL(
      "https://docs.google.com/forms/d/e/1FAIpQLSe6p-m67lHhtZOpM5n8Wsjxqhlt8bBRnL59Krf4ngeutIZLQQ/viewform?usp=sf_link"
    );
  };

  const handleFeedbackPress = () => {
    Linking.openURL(
      "https://docs.google.com/forms/d/e/1FAIpQLSe2vRvSn6Qitkmu348Xaj2ogZfvMhdogOBePlOmjx81hID5jw/viewform?usp=sf_link"
    );
  };
    ...
    <ImageBackground source={myLogoPic} style={stylesSupport.backgroundImage}>
      <ScrollView>
        ...
        <View style={stylesSupport.container}>
          ...
          <Text style={stylesSupport.editURL} onPress={handleFQAPress}>
            supportFQA
          </Text>

          <Text style={stylesSupport.subTitle}>Feedback Form:</Text>
          <Text style={stylesSupport.contactItem}>
            We would love to get a feedback:
          </Text>
          <Text style={stylesSupport.editURL} onPress={handleFeedbackPress}>
            FeedbackForm
          </Text>
        </View>
        <View>
          <Text style={stylesSupport.subTitleEnd}>Community Forums:</Text>
          <Text style={stylesSupport.contactItemEnd}>
            Join our community forums to interact with other users, ask
            questions, and share tips and advice related to sports activities.
          </Text>

          <Text style={stylesSupport.editURLEnd} onPress={handleCommunityPress}>
            OurCommunity
          </Text>
          <Text style={stylesSupport.subEnd}>Support Hours:</Text>
          {/* <Text></Text> */}
          <Text style={stylesSupport.textEnd}>
            Sonday to Thursday: 9:00 AM - 5:00 PM
          </Text>
